...
async function register(registerData) {
    ...
    if (registerData.username.length < 3) {
        throw { message: "Username should be at least 3 characters long!", data: registerData };
    }
    ...
    if (registerData.password.length < 3) {
        throw { message: "Password should be at least 3 characters long", data: registerData };
    }
...
async function login(loginData){
    ...
    if (loginData.username.length < 3) {
        throw { message: "Username should be at least 3 characters long!", data: loginData };
    }


    if (loginData.password.length < 3) {
        throw { message: "Password should be at least 3 characters long", data: loginData };
    }
    ...
    if (!user) {
        throw { message: "Incorect username and password!", data: loginDataa };
    }
